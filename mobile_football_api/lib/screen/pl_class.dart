...
class PlClass extends StatefulWidget {
  const PlClass({Key? key}) : super(key: key);

  @override
  State<PlClass> createState() => _PlClassState();
}

class _PlClassState extends State<PlClass> {
  ...
  Future<void> getClass() async {
    _class = await ClassementApi.getClassementPL();
    setState(() {
      _isloading = false;
    });
  }
